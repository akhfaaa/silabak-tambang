        ...
        <div class="px-5 py-6">
            ...
            <nav class="space-y-1.5">
                ...
                <a href="{{ route('transaksi.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg font-medium transition-all {{ request()->routeIs('transaksi.*') ? 'bg-red-600 text-white shadow-md shadow-red-600/20' : 'text-slate-400 hover:bg-slate-800 hover:text-white group' }}">
                    <svg class="w-5 h-5 {{ request()->routeIs('transaksi.*') ? 'opacity-90' : 'opacity-70 group-hover:opacity-100 transition-opacity' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('kmeans.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg font-medium transition-all {{ request()->routeIs('kmeans.*') ? 'bg-red-600 text-white shadow-md shadow-red-600/20' : 'text-slate-400 hover:bg-slate-800 hover:text-white group' }}">
                    <svg class="w-5 h-5 {{ request()->routeIs('kmeans.*') ? 'opacity-90' : 'opacity-70 group-hover:opacity-100 transition-opacity' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
